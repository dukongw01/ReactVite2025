...
export default function Hodolist(){
    const Hodo = [
        // 견과류
        ...
        // 일반 호두과자
        {id:4, name:'간식용 호두과자', title:'cocosnack_1.jpg', price:21000, category:'snack', quantity:1 },
        {id:5, name:'단체 간식용 호두과자', title:'cocosnack_3.jpg', price:4000, category:'snack', quantity:1 },
        // 크림 호두과자
        {id:6, name:'딸기 크림치즈(소)', title:'cocosnack_6.jpg', price:5200, category:'cream', quantity:1 },
        {id:7, name:'딸기 크림치즈(대)', title:'cocosnack_7.jpg', price:10400, category:'cream', quantity:1 },
        {id:8, name:'플레인 크림치즈(소)', title:'cocosnack_8.jpg', price:5200, category:'cream', quantity:1 },
        {id:9, name:'플레인 크림치즈(대)', title:'cocosnack_9.jpg', price:10400, category:'cream', quantity:1 },
        // 앙버터
        ...
        // 초코딸기, 선물용
        {id:14, name:'딸기 호두과자', title:'cocosnack_10.jpg', price:5000, category:'gift', quantity:1 },
        {id:15, name:'초코 호두과자', title:'cocosnack_14.jpg', price:5000, category:'gift', quantity:1 },
        {id:16, name:'초코베리', title:'cocosnack_16.jpg', price:4000, category:'gift', quantity:1 },
        {id:17, name:'프리백', title:'cocosnack_17.jpg', price:6600, category:'gift', quantity:1 },
        {id:18, name:'레드컵', title:'cocosnack_19.jpg', price:4400, category:'gift', quantity:1 },
    ...
    return(
        ...
        //     <img src={Hodo.title} alt={Hodo.name} />
        // </div>
        <div>
            {/* <ul>
                {Hodo.map((item)=>(
                    <li key={item.id}>
                    <img src={`/img/${item.title}`} alt={item.title} /> </li>
                ))}
            </ul> */}
        </div>
    )
